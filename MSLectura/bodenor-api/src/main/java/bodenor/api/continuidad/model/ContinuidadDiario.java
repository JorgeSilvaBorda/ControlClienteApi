...
@ApplicationScoped
@Entity(name = "CONTINUIDADDIARIO")
public class ContinuidadDiario implements Serializable{
    ...
    public ContinuidadDiario() {
    }

    public ContinuidadDiario(Integer anio, Integer mes, Integer dia, Integer numremarcador, Double lecturarealini, Double lecturarealfin, Double lecturaproyectadaini, Double lecturaproyectadafin, String timelecturaini, String timelecturafin, Double maxpotencia, Double maxpotenciahpunta, Double prompotencia, Double prompotenciahpunta) {
        this.anio = anio;
        this.mes = mes;
        this.dia = dia;
