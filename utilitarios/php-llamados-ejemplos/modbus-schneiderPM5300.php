...
echo "Connected successfully";
$sql2= "INSERT INTO CONSUMO (`TIMESTAMP`, `REMARCADOR_ID`, `EnergiaActivaConsumida_KWH`, `PotenciaActivaTotal_KW`, `FECHA`, `ANIO`, `MES`, `DIA`, `HORA`, `HH`, `MM`, `SS`) SELECT `TIMESTAMP` , `EQUIPO_ID` , cast(ITEM1 as decimal(27,2)) , cast(ITEM43 as decimal (27,2)) , `FECHA` , `ANIO` , `MES` , `DIA` , `HORA` , `HH` , `MM` , `SS` FROM `schneiderPM3500` WHERE NOT EXISTS ( SELECT * FROM CONSUMO WHERE `REMARCADOR_ID` = '$idequipo' AND `TIMESTAMP` = '$fecha' )  AND `EQUIPO_ID` = '$idequipo' AND `TIMESTAMP` = '$fecha'";
